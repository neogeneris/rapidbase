...
/**
 * EB (Engine Builder) - Inicia la cadena en el nuevo motor fragmentado.
 * 
 * Equivalente a B pero usando los componentes del SQLEngine.
 */
class EB
{
    ...
    public function __construct(JoinManager $joinManager = null)
    {
    ...
    public function getJoinManager(): JoinManager
    {
