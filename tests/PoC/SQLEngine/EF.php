...
/**
 * EF (Engine Finalizer) - Finaliza la cadena en el nuevo motor fragmentado.
 * 
 * Equivalente a F pero usando los componentes del SQLEngine.
 * Interfaz común con F para permitir interchangeabilidad.
 */
class EF
{
    ...
    /**
     * Crea una instancia EF desde una instancia EB.
     */
    public static function fromBuilder(EB $builder): self
    {
