 ...
 * 
 * Uso:
 *   php tdd-runner.php --all              Ejecuta todas las pruebas
 *   php tdd-runner.php --first            Ejecuta hasta el primer fallo
 *   php tdd-runner.php --failing          Re-ejecuta solo las que fallaron
 *   php tdd-runner.php --stats            Muestra estadísticas
 *   php tdd-runner.php --history [limit]  Muestra historial
 *   php tdd-runner.php --scan             Escanea y lista endpoints disponibles
 *   php tdd-runner.php ConnectionManager  Ejecuta solo pruebas de ConnectionManager
 */
...
$runner = new \RapidBase\Tdd\Runner(
    dbPath: __DIR__ . '/../../data/rapidbase_tdd.sqlite',
    basePath: __DIR__
);
...
Usage: php tdd-runner.php [command] [options]
...
Commands:
  ...
  <EndpointName>  Run tests for specific endpoint (e.g., ConnectionManager)
...
Examples:
  php tdd-runner.php --all -v       # Run all tests with verbose output
  php tdd-runner.php --first        # Stop on first failure (TDD mode)
  php tdd-runner.php --failing      # Fix failing tests iteratively
  php tdd-runner.php --scan         # See what endpoints are available
  php tdd-runner.php ConnectionManager  # Run only ConnectionManager tests
