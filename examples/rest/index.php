...
<body>
    ...
    <script>
        // Simulated data for demonstration (in real use, this comes from fetch)
        const mockData = [
            ...
            {id: 3, name: "Charlie Brown", email: "charlie@example.com", created_at: "2024-03-10"},
            {id: 4, name: "Diana Prince", email: "diana@example.com", created_at: "2024-04-05"},
            {id: 5, name: "Eve Adams", email: "eve@example.com", created_at: "2024-05-12"}
        ];
        ...
        function updatePreview() {
            ...
            if (sortColumn) {
                ...
                filteredData.sort((a, b) => {
                    if (a[sortColumn] < b[sortColumn]) return isDesc ? 1 : -1;
                    if (a[sortColumn] > b[sortColumn]) return isDesc ? -1 : 1;
                    return 0;
                });
            }
            ...
            metaDiv.innerHTML = `
                ...
                Showing ${paginatedData.length} of ${total} records | 
